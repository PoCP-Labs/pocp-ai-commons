...
| **P2** | Protocol Layer — Entity Dialogue (EDP) | `cd backend && python -m pytest -q tests/test_entity_dialogue.py` green; see [docs/protocol/ENTITY-DIALOGUE-PROTOCOL.md](./docs/protocol/ENTITY-DIALOGUE-PROTOCOL.md) · [agents/missions/protocol-layer-edp/MANIFEST.md](./agents/missions/protocol-layer-edp/MANIFEST.md) |
