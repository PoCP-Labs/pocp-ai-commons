...
print("\nPoCP Open Core Quality patch applied.")
print("Next:")
print("1. Open Cursor.")
print("2. Paste CURSOR_APPLY_PROMPT.md.")
print("3. Let Cursor format code and update README carefully.")
print("4. Run backend/scripts/health_check.py.")
print("5. Commit on branch: open-core-quality-core.")
